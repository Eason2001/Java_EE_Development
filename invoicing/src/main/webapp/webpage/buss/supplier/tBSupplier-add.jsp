...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBSupplierController.do?doAdd" tiptype="4">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="suppliertel" name="suppliertel" type="text" datatype="n0-13" style="width: 150px" class="inputxt"  
				...
				<tr>
					...
					<td class="value">
					     	 <input id="supplieremail" name="supplieremail" datatype="e" type="text" style="width: 150px" class="inputxt"  
				...
				<tr>
					...
					<td class="value">
					     	 <input id="suppliernum" name="suppliernum" type="text" datatype="*1-15" style="width: 150px" class="inputxt"  
				...
				<tr>
					...
					<td class="value">
					     	 <input id="contactperson" name="contactperson" type="text" datatype="*0-10" style="width: 150px" class="inputxt"  
