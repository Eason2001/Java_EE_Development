...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBPurchaseController.do?doUpdate" tiptype="4">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="goodsnumber" name="goodsnumber" type="text" datatype="*1-20" style="width: 150px" class="inputxt"  
									               
									                 value='${tBPurchasePage.goodsnumber}'>
					...
					type="hidden" value="${tBPurchasePage.goodsid}" id="goodsid"> 
					 <input	name="goodsname" class="inputxt" value="${tBPurchasePage.goodsname }" id="goodsname"
					...
					<tr>
						...
						<td class="value">
						     	 <input id="goodscount" name="goodscount" type="text" datatype="n1-10" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${tBPurchasePage.goodscount}'>
							<span class="Validform_checktip"></span>
					...
					type="hidden" value="${tBPurchasePage.supplierid}" id="supplierid"> <input
					name="suppliername" class="inputxt" value="${tBPurchasePage.suppliername }" id="suppliername"
					...
					<tr>
						...
						<td class="value">
						     	 <input id="contactperson" name="contactperson" datatype="*1-10" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${tBPurchasePage.contactperson}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="persontel" name="persontel" type="text" datatype="m" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${tBPurchasePage.persontel}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="remark" name="remark" maxlength="100">${tBPurchasePage.remark}</textarea>
							<span class="Validform_checktip"></span>
