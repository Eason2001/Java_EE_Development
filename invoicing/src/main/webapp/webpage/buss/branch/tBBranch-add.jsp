...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBBranchController.do?doAdd" tiptype="4">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="branchadd" name="branchadd" type="text" datatype="*1-20" style="width: 150px" class="inputxt"  
				...
				<tr>
					...
					<td class="value">
					     	 <input id="leadertel" name="leadertel" type="text" style="width: 150px" datatype="m" class="inputxt"  
				...
				<tr>
					...
					<td class="value">
					     	 <input id="zipcode" name="zipcode" type="text" style="width: 150px" datatype="p" class="inputxt"  
