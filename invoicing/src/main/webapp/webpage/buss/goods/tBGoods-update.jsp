...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBGoodsController.do?doUpdate" tiptype="4">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="costprice" name="costprice" type="text" style="width: 150px" datatype="n1-10" class="inputxt"  
									               
									                 value='${tBGoodsPage.costprice}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="remark" maxlength="100" name="remark">${tBGoodsPage.remark}</textarea>
							<span class="Validform_checktip"></span>
