...
public class RoleController extends BaseController {
	...
	@ResponseBody
	public AjaxJson updateOperation(HttpServletRequest request) throws UnsupportedEncodingException {
		AjaxJson j = new AjaxJson();
		String roleId =request.getParameter("roleId");
		String functionId = request.getParameter("functionId");
		String operationcodes = URLDecoder.decode(request.getParameter("operationcodes"), "utf-8") ;
