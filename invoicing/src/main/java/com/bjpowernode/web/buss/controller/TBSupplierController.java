...
import com.bjpowernode.web.buss.entity.base.TBSupplierEntity;
import com.bjpowernode.web.buss.service.TBSupplierServiceI;
...
public class TBSupplierController extends BaseController {
	...
	public void datagrid(TBSupplierEntity tBSupplier,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		CriteriaQuery cq = new CriteriaQuery(TBSupplierEntity.class, dataGrid);
		//查询条件组装器
		com.bjpowernode.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, tBSupplier, request.getParameterMap());
		try{
		//自定义追加查询条件
		}catch (Exception e) {
