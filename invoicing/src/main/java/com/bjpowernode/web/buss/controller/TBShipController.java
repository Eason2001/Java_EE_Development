...
import com.bjpowernode.web.buss.entity.base.TBShipEntity;
import com.bjpowernode.web.buss.service.TBShipServiceI;
...
public class TBShipController extends BaseController {
	...
	public void datagrid(TBShipEntity tBShip,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		com.bjpowernode.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, tBShip, request.getParameterMap());
		try{
		//自定义追加查询条件
