...
import com.bjpowernode.web.buss.entity.base.TBPurchaseEntity;
import com.bjpowernode.web.buss.entity.base.TBStockEntity;
import com.bjpowernode.web.buss.service.TBPurchaseServiceI;
...
public class TBPurchaseController extends BaseController {
	...
	public void datagrid(TBPurchaseEntity tBPurchase,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		com.bjpowernode.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, tBPurchase, request.getParameterMap());
		try{
		//自定义追加查询条件
		}catch (Exception e) {
