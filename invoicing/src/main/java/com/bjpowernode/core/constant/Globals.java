...
public final class Globals {
	...
	public static Short Log_Leavel_ERROR=3;
	  ...
	  * 出入库单状态
	  */
	 public static String STATUS_PENDING = "1";//待审核
	 public static String STATUS_PASS = "2";//通过
	 public static String STATUS_REJECT = "3";//驳回
	 public static String STATUS_FINISH = "5";//完成
